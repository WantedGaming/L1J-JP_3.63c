...
public class L1FireCracker {

	private static Logger _log = Logger.getLogger(L1FireCracker.class.getName());
	
	@XmlAccessorType(XmlAccessType.FIELD)
	@XmlRootElement(name = "ItemEffectList")
	private static class ItemEffectList implements Iterable<L1FireCracker> {
		@XmlElement(name = "Item")
		private List<L1FireCracker> _list;

		public Iterator<L1FireCracker> iterator() {
	...
	public boolean use(L1PcInstance pc, L1ItemInstance item) {
		...
		S_SkillSound s_skillsound = new S_SkillSound(pc.getId(), effect.getGfxId());
