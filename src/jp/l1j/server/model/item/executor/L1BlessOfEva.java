...
public class L1BlessOfEva {

	private static Logger _log = Logger.getLogger(L1BlessOfEva.class.getName());
	
	@XmlAccessorType(XmlAccessType.FIELD)
	@XmlRootElement(name = "ItemEffectList")
	private static class ItemEffectList implements Iterable<L1BlessOfEva> {
		@XmlElement(name = "Item")
		private List<L1BlessOfEva> _list;

		public Iterator<L1BlessOfEva> iterator() {
	...
	private static final String _path = "./data/xml/Item/BlessOfEva.xml";

	private static HashMap<Integer, L1BlessOfEva> _dataMap = new HashMap<Integer, L1BlessOfEva>();

	public static L1BlessOfEva get(int id) {
	...
	public static void reload() {
		HashMap<Integer, L1BlessOfEva> dataMap = new HashMap<Integer, L1BlessOfEva>();
		loadXml(dataMap);
		_dataMap = dataMap;
	}
	...
	public boolean use(L1PcInstance pc, L1ItemInstance item) {
		...
		pc.broadcastPacket(new S_SkillSound(pc.getId(), effect.getTime()));
