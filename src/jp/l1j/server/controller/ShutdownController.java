...
public class ShutdownController extends Thread {
	private static Logger _log = Logger.getLogger(ShutdownController.class.getName());
	private static ShutdownController _instance;
	private static ShutdownController _counterInstance = null;
	 ...
	 * 
	 */
	public ShutdownController(int seconds, boolean restart) {
		if (seconds < 0) {
			seconds = 0;
		}
		secondsShut = seconds;
	...
	public static ShutdownController getInstance() {
		if (_instance == null) {
			_instance = new ShutdownController();
		}
		return _instance;
	}
	...
	public void startShutdown(L1PcInstance activeChar, int seconds,
		...
		// new instance
		_counterInstance = new ShutdownController(seconds, restart);
